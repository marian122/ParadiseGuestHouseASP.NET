namespace ParadiseGuestHouse.Common
{
    public static class GlobalConstants
    {
        ...
        public const string CountOfPeopleInRoomLength = "Максималния брой гости е 10.";

        public const string NumberOfBedsRange = "Броят на леглата трябва да е между 1 и 10";

        public const string ConfHallReserveGuestsMax = "Полето трябва де бъде между 0 и 100";

        public const string UserNameMaxLength = "Полето може да съдържа най-много 20 символа";

        public const string RestaurantReserveGuestsMax = "Полето трябва де бъде между 0 и 120";
